                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" action="">
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <input type="hidden" value="updatesupplier"
                                                                        id="updatesupplier" name="updatesupplier">
                                                                    <input type="hidden" value="<?= $row["id"] ?>"
                                                                        id="idsupplier" name="idsupplier">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    value="<?= ucwords($row["namasupplier"]) ?>"
                                                                                    id="namasupplier"
                                                                                    name="namasupplier">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="nohpsupplier"
                                                                                    class="control-label">No Telp
                                                                                </label>
                                                                                <input type="text" class="form-control"
                                                                                    id="nohpsupplier"
                                                                                    name="nohpsupplier"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="2"
                                                                                id="alamatsupplier"
                                                                                name="alamatsupplier"><?= $row["alamatsupplier"] ?></textarea>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit"
                                                                    ...
                                                                    id="tombol-updatesupplier"
                                                                    name="tombol-updatesupplier">Save</button>
                                                            </div>
                                                        </form>
