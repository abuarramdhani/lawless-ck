                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="usubkategoribarang"
                                        id="usubkategoribarang">
                                        <option>Pilih Kategori</option>
                                        <?php foreach ($subkatbarang as $row) : ?>
                                        <option value="<?= $row["kodesubkatbarang"] ?>">
                                            <?= ucwords($row['namasubkatbarang'])  ?></option>
                                ...
                                <div class="form-group">
                                    <label>Nama barang</label>
                                    <input type="text" class="form-control" required name="unamabarang" id="unamabarang"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Harga Beli</label>
                                    <input type="text" class="form-control" required name="uhargabeli" id="uhargabeli"
                                        placeholder="Harga Beli"></input>
                                </div>
                                <div class="form-group">
                                    <label>Unit Beli</label>
                                ...
                                <div class="form-group">
                                    <label>Stok</label>
                                    <input type="text" class="form-control" required name="ustok" id="ustok"
                                        placeholder="Jumlah Stok"></input>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Harga Jual 1</label>
                                    <input type="text" class="form-control" required name="uhargajual1" id="uhargajual1"
                                        placeholder="Harga Jual 1"></input>
                                </div>
                                <div class="form-group">
                                    <label>Harga Jual 2</label>
                                    <input type="text" class="form-control" required name="uhargajual2" id="uhargajual2"
                                        placeholder="Harga Jual 2"></input>
                                </div>
                                <div class="form-group">
                                    <label>Unit Jual</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="uminstok" id="uminstok"
                                        placeholder="Minimal Stok"></input>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
