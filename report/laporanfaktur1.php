                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                <div class="dropdown pull-right">
                                    <button class="btn btn-success waves-effect waves-light">Total Faktur Rp.
                                        <?= format_rupiah($totalfaktur); ?></button>
                                </div>

                                <form method="post" action="">
                                    <input type="hidden" name="reportfilter_range">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon waves-effect waves-light btn-success btn-xs m-b-5"
                                                    data-toggle="modal"
                                                    data-target="#custom-width-modal<?= $row['No_form']; ?>"><?= $row['No_form']; ?></a>

                                                <!-- sample modal content -->

                                                <div id="custom-width-modal<?= $row['No_form']; ?>" class="modal fade"
                                                    ...
                                                    <div class="modal-dialog" style="width:55%;">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" id="custom-width-modalLabel">No
                                                                    <?= $row['No_form']; ?></h4>
                                                            </div>
                                                                ...
                                                                <table class="table table-bordered m-0">
                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                            ...
                                                                            $totali = $inp['total_i'];
                                                                            ?>
                                                                        <?php foreach ($detailfaktur as $row1) : ?>
                                                                        <tr>
                                                                            <th scope="row"><?= $ii++; ?></th>
                                                                            <td>

                                                                                <?php
                                                                                        $kodebarang = $row1["kodebahan"];
                                                                            ...
                                                                            <td><?= format_rupiah($row1['subtotal']) ?>
                                                                            </td>
                                                                        </tr>
                                                                        <?php endforeach ?>
                                                                        <tr>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="report?No_form=<?= $noform; ?>" target="_blank"
                                            ...
                                            <td align="right"><?= tgl_indo($row['jatuhtempo']) ?></td>
                                            <td align="right"><?= format_rupiah($totali) ?></td>
                                            <td align="center"><a
                                                    class="btn btn-icon waves-effect waves-light btn-success btn-xs m-b-5"
                                                    data-toggle="modal"
                                                    data-target="#custom-width-modal<?= $row['No_form']; ?>">Details</a>
