                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $cekbarang = mysqli_query($conn, "SELECT * FROM item_out WHERE kodebahan ='$kodebarang' ");
                                            ?>
                                        <?php if (mysqli_num_rows($cekbarang) > 0) : ?>
                                        <?php
                                                $jumlahi = "SELECT SUM(subtotal) AS total_i FROM item_out WHERE kodebahan ='$kodebarang'"; //perintah untuk menjumlahkan
                                                ...
                                                $jumlahqty = "SELECT SUM(qty) AS total_qty FROM item_out WHERE kodebahan ='$kodebarang'"; //perintah untuk menjumlahkan
                                                $hasilqty = mysqli_query($conn, $jumlahqty); //melakukan query dengan varibel $jumlahkan
                                                $inpqty = mysqli_fetch_array($hasilqty); //menyimpan hasil query ke variabel $t
                                                $totalqty = $inpqty['total_qty'];
                                                ?>
                                        <tr>
                                            <td><?= $i++; ?></td>
