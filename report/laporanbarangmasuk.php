                            ...
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $nama_barang = query("Select namabarang from barang where kodebarang = '$kodebarang' ")[0];
                                        $kodeunit = $row['unit'];
                                        $nama_unit = query("Select namaunit from unit where kodeunit = '$kodeunit' ")[0];
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $nama_barang['namabarang'] ?></td>
                                            <td><?= $row['harga'] ?></td>
                                            <td><?= $row['qty'] ?></td>
                                            <td><?= $nama_unit['namaunit'] ?></td>
                                            <td><?= $row['subtotal'] ?></td>
                                        </tr>
                                        <?php endforeach ?>
