                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <div class="pull-right">
                                    <a href="r-bahan?No_form=<?= $No_form; ?>" target="_blank" class="btn btn-inverse waves-effect waves-light"><i class="fa fa-print m-r-5"></i>Cetak</a>
                                    <!-- <?php if ($sot == 2 and $sck == 2) : ?>
                                        <a href="r_storebahan?No_form=<?= $No_form; ?>" target="_blank" class="btn btn-inverse waves-effect waves-light"><i class="fa fa-print m-r-5"></i>Cetak Surat Jalan</a>
                                    <?php else : ?>
                                ...
                                <a href="../report/laporanorderbahan.php" class="btn btn-primary"><i class="fa fa-angle-left" style="margin-right: 8px;"></i>Back</a>
                            </div>
                        </div><!-- end col -->
                    </div>
                    <!-- end row -->
