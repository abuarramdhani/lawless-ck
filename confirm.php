    ...
    <div class="wrapper-page">
        ...
        <div class="m-t-40 card-box">
            ...
            <div class="panel-body">
                <form class="form-horizontal m-t-20" id="formmasuk" method="POST">
                    ...
                    <div class="form-group text-center m-t-30">
                        <div class="col-xs-12">
                            <button class="btn btn-custom btn-bordred btn-block waves-effect waves-light" type="submit" id="tombol-simpan" name="simpan">Simpan</button>
                        </div>
                    </div>
                </form>
