                                ...
                                <form id="add-user" method="POST">
                                    ...
                                    <div class="form-group">
                                        <select class="select2 form-control" id="outlet" name="outlet">
                                            ...
                                            <option value="<?= $outlet['id'] ?>"><?= ucwords($outlet['nama']) ?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <select class="select2 form-control" id="jabatan" name="jabatan">
                                            ...
                                            <option value="<?=$jabatan['id']?>"><?= ucwords($jabatan['namajabatan'])?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select class="select2 form-control" id="outlet-edit" name="outlet">
                                <?php foreach($data['outlets'] as $outlet):?>
                                <option value="<?= $outlet['id'] ?>"><?= $outlet['kodeoutlet'].' - '.ucwords($outlet['nama']) ?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="select2 form-control" id="jabatan-edit" name="jabatan">
                                <?php foreach($data['jabatans'] as $jabatan):?>
                                <option value="<?=$jabatan['id']?>"><?= $jabatan['kodejabatan'].' - '.ucwords($jabatan['namajabatan'])?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                                ...
                                <form id="add-user" method="POST">
                                    ...
                                    <div class="form-group">
                                        <select class="select2 form-control" id="outlet" name="outlet">
                                            <option></option>
                                            <?php foreach($data['outlets'] as $outlet):?>
                                            <option value="<?= $outlet['kodeoutlet'] ?>"><?= ucwords($outlet['nama']) ?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <select class="select2 form-control" id="jabatan" name="jabatan">
                                            <option></option>
                                            <?php foreach($data['jabatans'] as $jabatan):?>
                                            <option value="<?=$jabatan['kodejabatan']?>"><?= ucwords($jabatan['namajabatan'])?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                    <input type="hidden" name="submit">
