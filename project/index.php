                                ...
                                <form id="formproyek">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect" id="tombol-proyek"
                                            name="tombol-proyek">Input Proyek</button>
                                        <!-- <button type="button" class="btn btn-info waves-effect waves-light">Save changes</button> -->
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card-box">
                                ...
                                <div class="dropdown pull-centre">
                                    <button class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                        data-target="#input-close-modal">Total Proyek : Rp.
                            ...
                            <div class="card-box table-responsive">
                                <div class="dropdown pull-right">
                                    ...
                                    <button class="btn btn-info waves-effect waves-light btn-xs m-b-5"
                                        data-toggle="modal" data-target="#modalproyek">Input Proyek</button>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-success">
                                                ...
                                                <a href="detailproyek.php?kp=<?= $row['noproyek']?>"
