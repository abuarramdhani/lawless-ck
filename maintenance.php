...
<body>
    ...
    <div class="progress progress-bar-custom-alt progress-sm m-b-0">
        <div class="progress-bar progress-bar-custom progress-bar-striped active" role="progressbar" aria-valuenow="91" aria-valuemin="0" aria-valuemax="100" style="width: 91%;">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <div class="home-wrapper">
                        ...
                        <h1 class="home-text text-uppercase text-custom text-white">Site is Under Maintenance</h1>
                        <p class=" text-white">We're making the system more awesome.we'll be back shortly.</p>
                        <?php var_dump($_SESSION['kodeoutlet']) ?>
                        <!-- <?php if (!isset($_SESSION['outlet'])) : ?>
                            <p class="text-white"> Tidak ada Session Outlet</p>
                        <?php elseif (!isset($_SESSION['kodeoutlet'])) : ?>
                            <p class="text-white"> Tidak ada Session Outlet</p>
                        <?php endif ?> -->
