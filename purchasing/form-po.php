                            ...
                            <div class="col-lg-12">
                                <form action="" method="POST">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="example-input1-group2" name="keyword_form-po" class="form-control" placeholder="Search">
                                    </div>
                                </form>
                            </div>
                        </div>
                                            ...
                                            <?php if ($keyword) : ?>
                                                <?php foreach ($bahan as $b) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $b['kodebahan'] ?></td>
                                                        <td><?= $b['namabahan']; ?></td>
                                                        <td> <button class="btn btn-icon waves-effect waves-light btn-success m-b-5"> <i class="fa fa-plus"></i> </button></td>
                                                    </tr>
                                                <?php endforeach ?>
                                            <?php endif ?>
                            ...
                            <div class="card-box" style="height:170px; ">
                                <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group  text-center" style="margin-top: 10px;">
                                        ...
                                        <button class="btn btn-purple waves-effect waves-light mr-1"> <span>Simpan</span>
                                        </button>
                                    </div>
