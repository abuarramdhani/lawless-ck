                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="detail_storeproduk.php?No_form=<?= $dp['No_form']; ?>"
                                                    ...
                                                    <div class="gal-detail thumb">
                                                        <a href="../assets/images/products/<?= $p['gambar']; ?>"
                                                            ...
                                                            <img src="../assets/images/products/<?= $p['gambar']; ?>"
                                                                class="thumb-img img-fluid" style="height: 220px;"
                                                                alt="work-thumbnail">
                                                        </a>
                                                        <div class="text-center">
                                                            <a href="javascript:;" id="add" data-id="<?= $p['id'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" readonly name="outlet" id="outlet"
                                                    class="form-control" value="<?= $_SESSION['outlet']; ?>">
