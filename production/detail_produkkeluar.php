                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Detail Produk Order</h4>
                                ...
                                <a href="../production/produk-keluar.php" class="btn btn-primary"><i class="fa fa-angle-left" style="margin-right: 8px;"></i>Back</a>
                            </div>
                        </div><!-- end col -->
                    </div>
                    <!-- end row -->
